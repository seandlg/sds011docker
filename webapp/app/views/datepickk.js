...
function Datepickk(args) {
	...
	function generateInputs() {
		...
		for (var x = 0; x < months; x++) {
			...
			container.setAttribute('class', 'd-tablee');
			for (var i = 0; i < 42; i++) {
	...
	function generateDates(year, month) {
		var monthElements = that.el.querySelectorAll('.d-tablee');
		var ws = weekStart !== null ? weekStart : languages[lang].weekStart;

		[].slice.call(that.el.querySelectorAll('.d-tablee')).forEach(function (element, index) {
			...
			[].slice.call(element.querySelectorAll('.d-tablee input')).forEach(function (inputEl, i) {
	...
	function resetCalendar() {
		[].slice.call(that.el.querySelectorAll('.d-tablee input')).forEach(function (inputEl) {
			inputEl.checked = false;
		});
...
var template = '<div class="d-title"></div>' + '<div class="d-calendar">' + '<div class="d-header">' + '<i id="d-previous"></i>' + '<p><span class="d-month"></span><span class="d-year"></span></p>' + '<i id="d-next"></i>' + '</div>' + '<div class="d-month-picker">' + '<div data-month="1">1</div>' + '<div data-month="2">2</div>' + '<div data-month="3">3</div>' + '<div data-month="4">4</div>' + '<div data-month="5">5</div>' + '<div data-month="6">6</div>' + '<div data-month="7">7</div>' + '<div data-month="8">8</div>' + '<div data-month="9">9</div>' + '<div data-month="10">10</div>' + '<div data-month="11">11</div>' + '<div data-month="12">12</div>' + '</div>' + '<div class="d-year-picker">' + '<div data-year="-5"></div>' + '<div data-year="-4"></div>' + '<div data-year="-3"></div>' + '<div data-year="-2"></div>' + '<div data-year="-1"></div>' + '<div data-year="0"></div>' + '<div data-year="1"></div>' + '<div data-year="2"></div>' + '<div data-year="3"></div>' + '<div data-year="4"></div>' + '<div data-year="5"></div>' + '</div>' + '<div class="d-weekdays"></div>' + '<div class="d-tablees"></div>' + '</div>' + '<div class="d-legend"></div>' + '<button class="d-confirm"></button>' + '<div class="d-overlay"></div>';
